  ...
  return (
    <div className="action">
      <div onClick={handleProfileClick}>
        <img
          // src={`${process.env.REACT_APP_API}/images/users/${user.imageName}`}
          // alt={user.imageName}
          className="profile"
        />
      </div>
      <div ref={menuRef} className={`menu ${isMenuOpen ? 'active' : ''}`}>
        <h3>"username"<br /><span>Administrador</span></h3>
        <ul>
          <li>
          ...
          <li>
            ...
            <Link to="/edituser" onClick={handleLinkClick}>Editar Perfil</Link>
          </li>
          <li>
